...
export default defineComponent({
  ...
  components: { ProductCard, SortDropdown }, // Register ProductCard as a child component
  ...
  methods: {
    ...
    ...mapActions("products", ["fetchProducts"]), // Remove sortProducts since we're not using it
